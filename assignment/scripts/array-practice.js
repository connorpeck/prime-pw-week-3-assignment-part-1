...
let favoriteFoods = ['Pasta','Tacos', 'Fish'];

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log('This is a list of my favorite foods: ', favoriteFoods);
...
console.log('Added curry to the end of my list', favoriteFoods);
...
console.log('Added curry to the front of my list', favoriteFoods);
...
console.log( 'My food list is now', favoriteFoods);
